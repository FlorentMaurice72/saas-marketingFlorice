 ...
 * (a client-side hook that requires a boundary).
 */
    ...
    <div className="w-full max-w-md">
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Connectez-vous à votre espace FlowMarketing
        </p>
      </div>
      ...
      <Card className="shadow-lg shadow-slate-200/50">
        ...
        <CardContent>
          ...
          {/* Google placeholder — ready for OAuth provider */}
          <button
            disabled
            className="flex h-10 w-full items-center justify-center gap-2.5 rounded-lg border border-slate-200 bg-white text-sm font-medium text-slate-600 opacity-50 cursor-not-allowed"
          >
